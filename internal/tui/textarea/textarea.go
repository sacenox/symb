...
// applications with syntax highlighting support.
//
// This is a custom textarea based on charmbracelet/bubbles/textarea
// (https://github.com/charmbracelet/bubbles/blob/master/textarea/textarea.go)
// extended with Chroma syntax highlighting support.
//
// Key modifications:
//   - Added Language field to enable syntax highlighting
//   - Added highlightLine() method using Chroma for tokenization and formatting
//   - Modified View() method to apply highlighting before rendering
//   - Integrated with internal/constants for configurable theme selection
package textarea
...
func (m *Model) highlightLine(text string) string {
	...
	// Use configured theme from constants
	style := styles.Get(constants.SyntaxTheme)
	if style == nil {
		style = styles.Fallback
	}

	// Create a terminal formatter with TrueColor support
